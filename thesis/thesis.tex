...
\begin{enumerate}
	\item $\forall (i,j) \in \mathtt{Indices}: \pi_i(\omega) \not\equiv \pi_j(\omega) \Rightarrow \eta(\pi_i(\omega)) \equiv \eta(\pi_j(\omega))$,
	\item $\exists (i,j) \in \mathtt{Indices}: \pi_i(\chi) \not\equiv \pi_j(\chi) $
\end{enumerate}

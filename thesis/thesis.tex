...
Let $\mathcal{M}$ be a Chemical Reaction Model. By iterative reaction application on initial vector $\vv{\nu}$ and all consequently created state vectors, we obtain an LTS (ref).
\end{definition}

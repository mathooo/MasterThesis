...
Biochemical Space (BCS,~\cite{BCS}) is ...

** short intro, mention it is part of CMP~\cite{cs2bio2013} !!!
...
In section~\ref{level_of_abstraction}, we have motivated the level of abstraction we need to use in BCS. 
...
In this section, we define grammar for the BCSL. As proposed in (ref), the syntax must be simple and readable. It was already defined in~\cite{Ded201627}, here we give just simplified version of the definition.

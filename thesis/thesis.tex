...
{\scriptsize (We just saved years of computing and terabytes of memory.)\\}
...
\caption{A fragment of the model Yamada 2004~\cite{yamada2004model} of FGF signaling pathway written in BCSL. The complete model can find in Appendix~\ref{yamada_complete}.}\label{fgf_fragment}
\end{figure}

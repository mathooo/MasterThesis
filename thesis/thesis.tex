...
Sets $\mathbbmss{X}_1, \ldots, \mathbbmss{X}_n \subseteq \mathds{X}_\sqsubseteq$ are \emph{compatible sets} iff for each compatible set $\mathbbmss{X}$ hold the following conditions:
\begin{center}
\begin{enumerate}

...
For better readability, we provide examples of syntax for most important object with their definition. The formal definition of syntax and the relation to the objects will be given later.

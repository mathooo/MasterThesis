...
$ERK(Thr\{u\})::cyt$ & + & $MEK(Ser212\{p\},Ser298\{p\})::cyt ~~\Rightarrow$\\
 & $\Rightarrow$ & $ MEK(Ser212\{p\},Ser298\{p\}).ERK(Thr\{u\})::cyt$\\
$Ras(Thr\{u\})::cyt$ & + & $FRS(Thr\{p\},Tyr\{u\}).GS(Thr\{u\})::cyt ~~\Rightarrow$\\
 & $\Rightarrow$ & $ FRS(Thr\{p\},Tyr\{u\}).GS(Thr\{u\}).Ras(Thr\{u\})::cyt$\\
$FRS(Thr\{u\})::cyt$ & + & $FGF(Thr\{p\}).R.FGF(Thr\{p\}).R::cyt ~~\Rightarrow$\\
 & $\Rightarrow$ & $ FGF(Thr\{p\}).R.FGF(Thr\{p\}).R.FRS(Thr\{u\})::cyt$\\
 $ERK(Tyr\{u\})::cyt$ & + & $MEK(Ser212\{p\},Ser298\{p\})::cyt ~~\Rightarrow$\\
 & $\Rightarrow$ & $ MEK(Ser212\{p\},Ser298\{p\}).ERK(Tyr\{u\})::cyt$\\
 $FRS(Tyr\{u\})::cyt$ & + & $ERK(Tyr\{p\},Thr\{p\})::cyt ~~\Rightarrow$\\
  & $\Rightarrow$ & $ ERK(Tyr\{p\},Thr\{p\}).FRS(Tyr\{u\})::cyt$\\
\end{tabular}
\egroup
\end{center}
}

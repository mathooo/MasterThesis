...
Before we can eliminate such rules, we have to detect them. For this purpose, compatibility operator and resulting ordered sets $\mathbbmss{X}$ can be used.

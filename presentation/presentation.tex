...
Webový framework pre \textbf{integráciu} biologických znalostí s výpočtovými modelmi a experimentami.
...
E + S\{\textcolor{mygreen}{i}\} $\Rightarrow$ E\textcolor{red}{.}S\{\textcolor{mygreen}{i}\}

E\textcolor{red}{.}S\{\textcolor{mygreen}{i}\} $\Rightarrow$ E\textcolor{red}{.}S\{\textcolor{mygreen}{a}\}
...
\item Statická analýza \textbf{ne}dosiahnuteľnosti

\begin{itemize}
	\item overenie \textbf{ne}dosiahnuteľnosti na základe vlastnosti definovanej na pravidlách
\end{itemize}
...
\item overovanie dosiahnuteľnosti skupiny zvolených látok,
\item vizualizácia prechodových systémov (vrátane dosiahnuteľnosti),
